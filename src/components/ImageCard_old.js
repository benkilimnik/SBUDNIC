  ...
  return (
    <div key={item.id}>
      <div className="flex flex-col items-center h-full text-center">
        <img
          alt="team"
          className="flex-shrink-0 object-cover object-center w-10/12 mb-4 rounded-lg h-72"
          src={item.image}
        />
        <div className="w-full">
          ...
          <h3 className="mb-3 text-gray-500">{item.category}</h3>
          <p className="h-24 mb-4 line-clamp">{item.subtitle}</p>
                ...
                <div className="relative w-auto max-w-3xl mx-auto my-6">
                  ...
                  <div className="relative flex flex-col w-full border-0 rounded-lg shadow-2xl outline-none bg-gray-50 focus:outline-none">
                    ...
                    <div className="flex flex-col items-center">
                      <img
                        alt="team"
                        className="hidden sm:flex-shrink-0 sm:rounded-lg sm:w-5/12 sm:my-12 sm:h-80 sm:object-cover sm:object-center sm:mb-4"
                        src={item.image}
                      />
                    </div>
