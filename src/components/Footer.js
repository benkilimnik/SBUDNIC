      ...
      <footer class="text-gray-600 body-font">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a href="https://twitter.com/SbudnicS" className="ml-3 text-black transition duration-500 ease-out transform opacity-50 hover:scale-110 hover:opacity-100">
              <svg
                fill="currentColor"
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <a href="https://instagram.com/sbudnics" className="ml-3 text-black transition duration-500 ease-out transform opacity-50 hover:scale-110 hover:opacity-100">
              {" "}
              <svg
                fill="none"
                stroke="currentColor"
            ...
            <a href="https://www.linkedin.com/company/sbudnic/" className="ml-3 text-black transition duration-500 ease-out transform opacity-50 hover:scale-110 hover:opacity-100">
              {" "}
              <svg
                fill="currentColor"
                stroke="currentColor"
