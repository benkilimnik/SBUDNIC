...
const team = [
  ...
  },
  {
   id: 9,
    title: "Ashton Lam",
    subtitle: "Perpetually inventing, designing, and making. I get antsy if my hands stop moving.",
    category: "Marketing",
    image: ashton,
  },
  {
    id: 4,
    title: "Maddie Simon",
    subtitle: "I'm a member of the Brown class of '24 studying Biomedical Engineering! I'm super excited to be helping out with this project and have already learned so much.",
...

  {
    ...
    subtitle: "Rising junior from Framingham, MA studying Applied Math and Computer Science. As part of the OBDH team, I am working to ensure that our computer systems survive the radiation of space. Outside of school work I like to play hockey, build things, and reinvent the wheel.",
  ...
  },
  {
    ...
    subtitle: "First year from Los Angeles, California who plans on concentrating Computer Science. I love computers, engineering, and space, as well as surfing, watching movies, biking, and tinkering.",
    category: "Radio Engineer, Programmer",
    image: space3,
  },
]
